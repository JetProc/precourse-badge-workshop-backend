...
const ACHIEVEMENT_DEFINITIONS = {
  ...
  review_thanked: {
    name: '고마워요!',
    description: "(히든) 작성한 리뷰가 동료에게 '고맙다', '도움됐다'는 감사 인사를 받았습니다.",
  },
  review_study: {
    name: '탐구하는 리뷰어',
    description: '(히든) 더 나은 코드 리뷰를 하기 위해 1시간 이상 자료를 찾아봤습니다.',
  },
  review_self: {
    name: '스스로의 멘토',
    description: '자신의 PR에 스스로 20회 이상 코멘트(고민의 흔적)를 남겼습니다.',
  },
  review_emoji_king: {
    name: '이모지 리액터',
  ...
  tdd_attempt: {
    name: 'TDD 선구자',
    description: '(히든) TDD(테스트 주도 개발)를 1회 이상 시도했습니다.',
  },
  readme_master: {
    name: '문서화의 달인',
